        ...
        <div className="flex items-center justify-between gap-4">
          <div ref={navRef} className="relative flex-1 min-w-0">
            <button
              ...
              className="w-full text-right p-2 -m-2 rounded-md hover:bg-slate-200/60 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
              aria-haspopup="true"
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <svg className={`h-5 w-5 text-slate-500 transition-transform duration-200 ${isNavOpen ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            {isNavOpen && (
              <div 
                ...
                className="absolute top-full left-0 mt-2 w-full max-w-xs sm:max-w-sm bg-white rounded-lg shadow-xl border border-slate-200 py-2 z-40"
              >
                    ...
                    <li key={docKey} role="none">
                      ...
                      >
                        <div className="flex flex-col">
                          ...
                          <span className={`text-xs ${activeDocument === docKey ? 'text-blue-600' : 'text-slate-500'}`}>{documents[docKey].buttonLabel}</span>
                        </div>
                        {activeDocument === docKey && (
